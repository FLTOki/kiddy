...
<div class="page-header md-shadow-z-1-i navbar navbar-fixed-top">
	...
	<div class="page-header-inner">
		...
		<div class="page-logo">
			<a href="index.php">
			<img src="assets/funb.png" alt="logo" class="logo-default"/>
			</a>
		...
		<div class="page-actions">
			<div class="btn-group">
				...
				<ul class="dropdown-menu" role="menu">
					...
					<li>
						<a href="javascript:;">
						<i class="icon-tag"></i> Add Product </a>
					</li>
					<li>
						<a href="javascript:;">
						<i class="icon-users"></i> Support <span class="badge badge-danger">2</span>
						</a>
					</li>
				</ul>
			</div>
					...
					<li class="dropdown dropdown-extended dropdown-notification " id="header_notification_bar">
						...
						<ul class="dropdown-menu">
							<li class="external">
								...
								<a href="extra_profile.php">view all</a>
							</li>
							<li>
